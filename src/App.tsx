...
export const App: React.FC = () => {
  ...
  const [selectedPerson, setSelectedPerson] = useState<null | { name: string; born: number; died: number }>(null);
  ...
  const handleSelectPerson = (person: { name: string; born: number; died: number }) => {
